    ...
    $.ajax({
        ...
        success: function (data, textStatus, xhr) {
            ...
            $.each(data, function (index, val) {
                ...
                $("#MainCont").append("  <div class='row NewQst' id='\Q" + val.QuestionId.toString().trim() + "'><p class='well'> Question  :" + i.toString() + "</p>   <p>" + val.FullQuestion + "</P> <div class='Options'> <p><strong> Options</strong></p> " +
                  ...
                  "<p class=\"showAnswer btn-success\">Show Answer</p>" +
                  "</div>");
